...
contract GnosisExecutorTest is BuilderExtensionsTest {
    address public gnosisExecutorImpl;
    ...
    function addGnosisExtension(string memory extensionName) public {
        gnosisExecutorImpl = address(new GnosisDAOExecutor(address(manager)));

        RevolutionBuilderTypesV1.DAOAddresses memory daoAddresses = RevolutionBuilderTypesV1.DAOAddresses({
            dao: manager.daoImpl(),
            executor: gnosisExecutorImpl,
    ...
    function test__AddAndRemoveExtension() public {
        ...
        addGnosisExtension(extensionName);
    ...
    function test__DeployGnosisExtension() public {
        ...
        // make new GnosisDAOExecutor instance and check avatars match
        GnosisDAOExecutor gnosisExecutor = GnosisDAOExecutor(daoAddresses.executor);
        assertEq(gnosisExecutor.avatar(), avatar, "Avatar mismatch");
    }
}
