...
contract AuctionHouseSettleTest is AuctionHouseTest {
    ...
    function test__VotesCount(uint8 nDays) public {
        ...
        // artRace currentVotes of highest bidder should be 10
        assertEq(
            artRace.votingPower().getVotesWithWeights(address(11), 1, artRace.revolutionTokenVoteWeight()),
    ...
    function test__TransferFailureAndFallbackToWETH(uint256 amount) public {
        ...
        assertEq(
            artRace.votingPower().getVotesWithWeights(address(this), 1, artRace.revolutionTokenVoteWeight()),
            artRace.revolutionTokenVoteWeight(),
            "Highest bidder should have 10 votes"
        );
    }
    ...
    function test__SettlingAuctionWithMultipleCreators(uint8 nCreators) public {
        ...
        vm.assume(nCreators < artRace.MAX_NUM_CREATORS());
        ...
        assertEq(
            artRace.votingPower().getVotesWithWeights(address(21_000), 1, artRace.revolutionTokenVoteWeight()),
            artRace.revolutionTokenVoteWeight(),
            "Highest bidder should have 10 votes"
        );
    }
