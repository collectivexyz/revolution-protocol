...
interface IRevolutionPointsEmitter is IGrantsRevenueStream, IRewardSplits {
    ...
    /// @dev Reverts if the min price is 0
    error MIN_PRICE_ZERO();
    ...
    event MinPriceUpdated(uint256 newMinPriceWei);
     ...
     * @param minPriceWei The minimum price of the token in wei
