...
import { ISuperfluid, ISuperToken, IConstantFlowAgreementV1, IInstantDistributionAgreementV1 } from "./interfaces/superfluid/ISuperfluid.sol";

import { IGeneralDistributionAgreementV1, ISuperfluidPool, PoolConfig } from "./interfaces/agreements/gdav1/IGeneralDistributionAgreementV1.sol";
...
library SuperTokenV1Library {
     ...
     * @param flowRate The desired flowRate
     */
    function updateFlow(ISuperToken token, address receiver, int96 flowRate) internal returns (bool) {
    ...
    function updateFlow(
        ...
        (ISuperfluid host, IConstantFlowAgreementV1 cfa) = _getAndCacheHostAndCFA(token);
        host.callAgreement(cfa, abi.encodeCall(cfa.updateFlow, (token, receiver, flowRate, new bytes(0))), userData);
        return true;
    }
     ...
     * @param receiver The receiver of the flow
     */
    function deleteFlow(ISuperToken token, address sender, address receiver) internal returns (bool) {
    ...
    function deleteFlow(
        ...
        (ISuperfluid host, IConstantFlowAgreementV1 cfa) = _getAndCacheHostAndCFA(token);
        host.callAgreement(cfa, abi.encodeCall(cfa.deleteFlow, (token, sender, receiver, new bytes(0))), userData);
        return true;
    }
    ...
    function setFlowPermissions(
        ...
        (ISuperfluid host, IConstantFlowAgreementV1 cfa) = _getAndCacheHostAndCFA(token);
        uint8 permissionsBitmask = (allowCreate ? 1 : 0) | ((allowUpdate ? 1 : 0) << 1) | ((allowDelete ? 1 : 0) << 2);
        host.callAgreement(
            cfa,
            abi.encodeCall(
     ...
     * @param flowOperator The address given flow permissions
     */
    function setMaxFlowPermissions(ISuperToken token, address flowOperator) internal returns (bool) {
        (ISuperfluid host, IConstantFlowAgreementV1 cfa) = _getAndCacheHostAndCFA(token);
        host.callAgreement(
            cfa,
            abi.encodeCall(cfa.authorizeFlowOperatorWithFullControl, (token, flowOperator, new bytes(0))),
            new bytes(0)
        );
        return true;
    }
    ...
    function revokeFlowPermissions(ISuperToken token, address flowOperator) internal returns (bool) {
        ...
        host.callAgreement(
            cfa,
            abi.encodeCall(cfa.revokeFlowOperatorWithFullControl, (token, flowOperator, new bytes(0))),
            new bytes(0)
        );
        return true;
    }
    ...
    function decreaseFlowRateAllowance(
        ...
        host.callAgreement(
            cfa,
            abi.encodeCall(
                cfa.decreaseFlowRateAllowance,
                (token, flowOperator, subtractedFlowRateAllowance, new bytes(0))
            ),
            userData
        );
        return true;
    ...
    function createFlowFrom(
        ...
        host.callAgreement(
            cfa,
            abi.encodeCall(cfa.createFlowByOperator, (token, sender, receiver, flowRate, new bytes(0))),
            userData
        );
        return true;
    }
    ...
    function updateFlowFrom(
        ...
        host.callAgreement(
            cfa,
            abi.encodeCall(cfa.updateFlowByOperator, (token, sender, receiver, flowRate, new bytes(0))),
            userData
        );
        return true;
    }
     ...
     * @param receiver The receiver of the flow
     */
    function deleteFlowFrom(ISuperToken token, address sender, address receiver) internal returns (bool) {
    ...
    function deleteFlowFrom(
        ...
        host.callAgreement(
            cfa,
            abi.encodeCall(cfa.deleteFlowByOperator, (token, sender, receiver, new bytes(0))),
            userData
        );
        return true;
    }
     ...
     */
    function getFlowRate(ISuperToken token, address sender, address receiver) internal view returns (int96 flowRate) {
    ...
    ) internal view returns (uint256 lastUpdated, int96 flowRate, uint256 deposit) {
     ...
     */
    function getNetFlowRate(ISuperToken token, address account) internal view returns (int96 flowRate) {
        (, IConstantFlowAgreementV1 cfa) = _getHostAndCFA(token);
        (, IGeneralDistributionAgreementV1 gda) = _getHostAndGDA(token);
     ...
     * @return flowRate The net flow rate of the account
     */
    function getCFANetFlowRate(ISuperToken token, address account) internal view returns (int96 flowRate) {
        (, IConstantFlowAgreementV1 cfa) = _getHostAndCFA(token);
     ...
     * @return flowRate The net flow rate of the account
     */
    function getGDANetFlowRate(ISuperToken token, address account) internal view returns (int96 flowRate) {
        (, IGeneralDistributionAgreementV1 gda) = _getHostAndGDA(token);
    ...
    function getNetFlowInfo(
        ...
        {
            (uint256 lastUpdatedCFA, int96 cfaNetFlowRate, uint256 cfaDeposit, uint256 cfaOwedDeposit) = cfa
    ...
    function getPoolAdjustmentFlowRate(
        ISuperToken token,
        ISuperfluidPool pool
    ) internal view returns (int96 poolAdjustmentFlowRate) {
        (, IGeneralDistributionAgreementV1 gda) = _getHostAndGDA(token);
    ...
    function getTotalAmountReceivedByMember(
        ISuperfluidPool pool,
        address memberAddr
    ) internal view returns (uint256 totalAmountReceived) {
     ...
     */
    function getBufferAmountByFlowRate(ISuperToken token, int96 flowRate) internal view returns (uint256 bufferAmount) {
        (, IConstantFlowAgreementV1 cfa) = _getHostAndCFA(token);
    ...
    function getFlowPermissions(
        ...
        address sender,
        address flowOperator
    ) internal view returns (bool allowCreate, bool allowUpdate, bool allowDelete, int96 flowRateAllowance) {
        (, IConstantFlowAgreementV1 cfa) = _getHostAndCFA(token);
    ...
    function getIndex(
        ...
        address publisher,
        uint32 indexId
    ) internal view returns (bool exist, uint128 indexValue, uint128 totalUnitsApproved, uint128 totalUnitsPending) {
    ...
    function listSubscriptions(
        ISuperToken token,
        address subscriber
    ) internal view returns (address[] memory publishers, uint32[] memory indexIds, uint128[] memory unitsList) {
        (, IInstantDistributionAgreementV1 ida) = _getHostAndIDA(token);
     ...
     * @param indexId ID of the index.
     */
    function createIndex(ISuperToken token, uint32 indexId) internal returns (bool) {
     ...
     */
    function createIndex(ISuperToken token, uint32 indexId, bytes memory userData) internal returns (bool) {
     ...
     */
    function updateIndexValue(ISuperToken token, uint32 indexId, uint128 indexValue) internal returns (bool) {
     ...
     * NOTE due to rounding, there may be a small amount of tokens left in the publisher's account
     ...
     //
     */
    function distribute(ISuperToken token, uint32 indexId, uint256 amount) internal returns (bool) {
     ...
     * @param indexId ID of the index.
     */
    function approveSubscription(ISuperToken token, address publisher, uint32 indexId) internal returns (bool) {
     ...
     * @param indexId ID of the index.
     */
    function revokeSubscription(ISuperToken token, address publisher, uint32 indexId) internal returns (bool) {
     ...
     */
    function claim(ISuperToken token, address publisher, uint32 indexId, address subscriber) internal returns (bool) {
    ...
    function updateMemberUnits(
        ...
        host.callAgreement(
            gda,
            abi.encodeCall(gda.updateMemberUnits, (pool, memberAddress, newUnits, new bytes(0))),
            userData
        );
    ...
    function distribute(
        ...
        host.callAgreement(
            gda,
            abi.encodeCall(gda.distribute, (token, from, pool, requestedAmount, new bytes(0))),
            userData
        );
        return true;
    }
    ...
    function distributeFlow(
        ...
        host.callAgreement(
            gda,
            abi.encodeCall(gda.distributeFlow, (token, from, pool, requestedFlowRate, new bytes(0))),
            userData
        );
        return true;
    }
    ...
    function _getAndCacheHostAndIDA(
        ISuperToken token
    ) private returns (ISuperfluid host, IInstantDistributionAgreementV1 ida) {
        // check if already in contract storage...
        assembly {
            // solium-disable-line
            host := sload(_HOST_SLOT)
    ...
    // to be used in state changing methods
    function _getAndCacheHostAndGDA(
        ISuperToken token
    ) private returns (ISuperfluid host, IGeneralDistributionAgreementV1 gda) {
        // check if already in contract storage...
        assembly {
            // solium-disable-line
            host := sload(_HOST_SLOT)
    ...
    // to be used in non-state changing methods (view functions)
    function _getHostAndIDA(
        ISuperToken token
    ) private view returns (ISuperfluid host, IInstantDistributionAgreementV1 ida) {
        // check if already in contract storage...
        assembly {
            // solium-disable-line
            host := sload(_HOST_SLOT)
    ...
    // to be used in non-state changing methods (view functions)
    function _getHostAndGDA(
        ISuperToken token
    ) private view returns (ISuperfluid host, IGeneralDistributionAgreementV1 gda) {
        // check if already in contract storage...
        assembly {
            // solium-disable-line
            host := sload(_HOST_SLOT)
