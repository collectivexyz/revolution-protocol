...
contract SplitsTest is Test {
    ...
    function setUp() public {
        splits = new SplitMain(revolutionPoints);
    }
    ...
    function test__Revert_NoTreasurySplit() public {
        ...
        address split = splits.createSplit(pointsData, accounts, percentAllocations, distributorFee, controller);
    }
    ...
    function test__Revert_TooFewSplitAccounts() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(selector, 0));
        address split = splits.createSplit(
            pointsData,
            new address[](0),
            percentAllocations,
            distributorFee,
