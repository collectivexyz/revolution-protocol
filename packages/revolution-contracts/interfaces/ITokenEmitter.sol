...
interface ITokenEmitter {
    function buyToken(address[] memory _addresses, uint[] memory _percentages, address builder, address purchaseReferral, address deployer) external payable returns (uint256);
