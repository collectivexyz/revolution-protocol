...
/// @title The Verbs DAO proxy contract for V1
...
// VerbsDAOProxyV1.sol is a modified version of NounsDAOProxy.sol, tailored for the Verbs DAO.
// Its main purpose is to support people wishing to deploy V2 directly, without having to deploy V1 first and then upgrade.

// LICENSE
// VerbsDAOProxy.sol is a modified version of Compound Lab's GovernorBravoDelegator.sol:
...
//
//
// VerbsDAOProxy.sol uses parts of Open Zeppelin's Proxy.sol:
